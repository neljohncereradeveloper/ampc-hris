  ...
  async run(
    ...
    const rolePermissionMappings: Record<string, string[]> = {
      [ROLES.ADMIN]: [
        ...
        // all leave balance permissions (leave-management)
        PERMISSIONS.LEAVE_BALANCES.CREATE,
        PERMISSIONS.LEAVE_BALANCES.READ,
        PERMISSIONS.LEAVE_BALANCES.CLOSE,
        PERMISSIONS.LEAVE_BALANCES.CLOSE_BALANCES_FOR_EMPLOYEE,
        PERMISSIONS.LEAVE_BALANCES.RESET_FOR_YEAR,
        PERMISSIONS.LEAVE_BALANCES.GENERATE_BALANCES_FOR_ALL_EMPLOYEES,
        // all leave request permissions (leave-management)
        PERMISSIONS.LEAVE_REQUESTS.CREATE,
        PERMISSIONS.LEAVE_REQUESTS.READ,
        PERMISSIONS.LEAVE_REQUESTS.UPDATE,
        PERMISSIONS.LEAVE_REQUESTS.APPROVE,
        PERMISSIONS.LEAVE_REQUESTS.REJECT,
