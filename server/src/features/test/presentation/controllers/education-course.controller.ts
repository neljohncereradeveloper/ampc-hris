...
export class EducationCourseController {
  ...
  @ApiOperation({ summary: 'Create a new EducationCourse' })
  @ApiBody({ type: CreateEducationCoursePresentationDto })
  @ApiResponse({
    status: 201,
    description: 'EducationCourse created successfully',
  })
  ...
  @ApiOperation({ summary: 'Update EducationCourse information' })
  @ApiParam({ name: 'id', description: 'EducationCourse ID', example: 1 })
  @ApiBody({ type: UpdateEducationCoursePresentationDto })
  @ApiResponse({
    status: 200,
    description: 'EducationCourse updated successfully',
  })
  @ApiResponse({ status: 404, description: 'EducationCourse not found' })
  @ApiResponse({ status: 400, description: 'Bad request - validation error' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
  async update(
  ...
  @ApiOperation({ summary: 'Archive a EducationCourse' })
  @ApiParam({ name: 'id', description: 'EducationCourse ID', example: 1 })
  @ApiResponse({
    status: 200,
    description: 'EducationCourse archived successfully',
  })
  @ApiResponse({ status: 404, description: 'EducationCourse not found' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
  ...
  @ApiOperation({ summary: 'Restore a EducationCourse' })
  @ApiParam({ name: 'id', description: 'EducationCourse ID', example: 1 })
  @ApiResponse({
    status: 200,
    description: 'EducationCourse restored successfully',
  })
  @ApiResponse({ status: 404, description: 'EducationCourse not found' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
  ...
  @ApiOperation({ summary: 'Get paginated list of EducationCourses' })
  @ApiResponse({
    status: 200,
    description: 'EducationCourses retrieved successfully',
  })
  @ApiResponse({ status: 400, description: 'Bad request - validation error' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
  ...
  @RequireRoles(ROLES.ADMIN, ROLES.EDITOR, ROLES.VIEWER)
  @RequirePermissions(PERMISSIONS.EDUCATION_COURSES.READ)
  @ApiOperation({ summary: 'Get EducationCoursess combobox list' })
  @ApiResponse({
    status: 200,
    description: 'EducationCourses combobox retrieved successfully',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
