...
export class UpdateEducationCourseDto {
  @ApiProperty({
    description: 'EducationCourse description (desc1)',
    example: 'EducationCourse Example',
    minLength: 2,
    maxLength: 100,
    ...
    patternProperties: {
      description: {
        pattern: REGEX_CONST.LETTER_NUMBER_SPACE.toString(),
        message:
          'EducationCourse description can only contain letters, numbers, and spaces',
      },
    },
  })
  @RequiredStringValidation({
    field_name: 'EducationCourse description (desc1)',
    min_length: 2,
    max_length: 255,
