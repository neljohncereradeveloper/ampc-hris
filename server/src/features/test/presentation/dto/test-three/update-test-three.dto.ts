...
export class UpdateTestThreeDto {
  @ApiProperty({
    description: 'TestThree description (desc1)',
    example: 'TestThree Example',
    minLength: 2,
    maxLength: 100,
    ...
    patternProperties: {
      description: {
        pattern: REGEX_CONST.LETTER_NUMBER_SPACE.toString(),
        message:
          'TestThree description can only contain letters, numbers, and spaces',
      },
    },
  })
  @RequiredStringValidation({
    field_name: 'TestThree description (desc1)',
    min_length: 2,
    max_length: 255,
