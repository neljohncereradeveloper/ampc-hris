...
export class EmployeeController {
  ...
  async create(
    ...
    const command: CreateEmployeeCommand = {
      job_title_id: presentationDto.job_title_id,
      employment_type_id: presentationDto.employment_type_id,
      employment_status_id: presentationDto.employment_status_id,
      leave_type_id: presentationDto.leave_type_id,
      branch_id: presentationDto.branch_id,
      department_id: presentationDto.department_id,
      ...
      religion_id: presentationDto.religion_id,
      civil_status_id: presentationDto.civil_status_id,
      age: presentationDto.age,
      gender: presentationDto.gender,
      citizen_ship_id: presentationDto.citizen_ship_id,
      height: presentationDto.height,
      weight: presentationDto.weight,
      home_address_street: presentationDto.home_address_street,
      home_address_barangay_id: presentationDto.home_address_barangay_id,
      home_address_city_id: presentationDto.home_address_city_id,
      home_address_province_id: presentationDto.home_address_province_id,
      home_address_zip_code: presentationDto.home_address_zip_code,
      present_address_street: presentationDto.present_address_street,
      present_address_barangay_id: presentationDto.present_address_barangay_id,
      present_address_city_id: presentationDto.present_address_city_id,
      present_address_province_id: presentationDto.present_address_province_id,
