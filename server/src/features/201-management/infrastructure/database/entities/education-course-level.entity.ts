...
export class EducationCourseLevelEntity {
  ...
  @Column({
    type: 'varchar',
    length: 255,
    comment: 'Education course level description (desc1)',
  })
  @Index()
  desc1: string;
  ...
  @Column({
    ...
    length: 255,
    nullable: true,
    comment: 'User who deleted the education course level',
  })
  ...
  @Column({
    ...
    length: 255,
    nullable: true,
    comment: 'User who created the education course level',
  })
  ...
  @Column({
    ...
    length: 255,
    nullable: true,
    comment: 'User who last updated the education course level',
  })
