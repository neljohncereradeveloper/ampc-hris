...
export class EducationLevelController {
  ...
  @ApiOperation({ summary: 'Update education level information' })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({ summary: 'Archive an education level' })
  @ApiParam({
    name: 'id',
    description: 'Education level ID',
    example: 1,
  ...
  @ApiResponse({
    status: 200,
    description: 'Education level archived successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Education level not found',
  ...
  @ApiOperation({ summary: 'Restore an education level' })
  @ApiParam({
    name: 'id',
    description: 'Education level ID',
    example: 1,
  ...
  @ApiResponse({
    status: 200,
    description: 'Education level restored successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Education level not found',
  ...
  @ApiOperation({
    summary: 'Get paginated list of education levels',
  })
  @ApiResponse({
    status: 200,
  ...
  @RequirePermissions(PERMISSIONS.EDUCATION_LEVELS.READ)
  @ApiOperation({
    summary: 'Get education levels combobox list',
  })
  @ApiResponse({
    status: 200,
    description: 'Education levels combobox retrieved successfully',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
