...
export class EducationSchoolController {
  ...
  @ApiOperation({ summary: 'Create a new education school' })
  @ApiBody({ type: CreateEducationSchoolPresentationDto })
  @ApiResponse({
    status: 201,
    description: 'Education school created successfully',
  })
  ...
  @ApiOperation({ summary: 'Update education school information' })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    status: 200,
    description: 'Education school updated successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Education school not found',
  })
  @ApiResponse({ status: 400, description: 'Bad request - validation error' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
  ...
  @ApiOperation({ summary: 'Archive an education school' })
  @ApiParam({
    name: 'id',
    description: 'Education school ID',
    example: 1,
  ...
  @ApiResponse({
    status: 200,
    description: 'Education school archived successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Education school not found',
  ...
  @ApiOperation({ summary: 'Restore an education school' })
  @ApiParam({
    name: 'id',
    description: 'Education school ID',
    example: 1,
  ...
  @ApiResponse({
    status: 200,
    description: 'Education school restored successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Education school not found',
  ...
  @ApiOperation({
    summary: 'Get paginated list of education schools',
  })
  @ApiResponse({
    status: 200,
    description: 'Education schools retrieved successfully',
  })
  @ApiResponse({ status: 400, description: 'Bad request - validation error' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
  ...
  @RequirePermissions(PERMISSIONS.EDUCATION_SCHOOLS.READ)
  @ApiOperation({
    summary: 'Get education schools combobox list',
  })
  @ApiResponse({
    status: 200,
    description: 'Education schools combobox retrieved successfully',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
