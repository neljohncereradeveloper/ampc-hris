...
export class ReferenceController {
  ...
  @RequirePermissions(PERMISSIONS.REFERENCES?.CREATE || 'references:create')
  ...
  @Put(':id')
  @RequireRoles(ROLES.ADMIN, ROLES.EDITOR)
  @RequirePermissions(PERMISSIONS.REFERENCES?.UPDATE || 'references:update')
  ...
  @RequirePermissions(PERMISSIONS.REFERENCES?.ARCHIVE || 'references:archive')
  ...
  @HttpCode(HttpStatus.OK)
  @RequireRoles(ROLES.ADMIN)
  @RequirePermissions(PERMISSIONS.REFERENCES?.RESTORE || 'references:restore')
  ...
  @RequirePermissions(PERMISSIONS.REFERENCES?.READ || 'references:read')
