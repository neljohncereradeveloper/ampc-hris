...
@ApiTags('Education Course Level')
...
export class EducationCourseLevelController {
  ...
  @ApiOperation({ summary: 'Create a new education course level' })
  @ApiBody({ type: CreateEducationCourseLevelPresentationDto })
  @ApiResponse({
    status: 201,
    description: 'Education course level created successfully',
  })
  ...
  @ApiOperation({ summary: 'Update education course level information' })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    status: 200,
    description: 'Education course level updated successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Education course level not found',
  })
  @ApiResponse({ status: 400, description: 'Bad request - validation error' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
  ...
  @ApiOperation({ summary: 'Archive an education course level' })
  @ApiParam({
    name: 'id',
    description: 'Education course level ID',
    example: 1,
  ...
  @ApiResponse({
    status: 200,
    description: 'Education course level archived successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Education course level not found',
  ...
  @ApiOperation({ summary: 'Restore an education course level' })
  @ApiParam({
    name: 'id',
    description: 'Education course level ID',
    example: 1,
  ...
  @ApiResponse({
    status: 200,
    description: 'Education course level restored successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Education course level not found',
  ...
  @ApiOperation({
    summary: 'Get paginated list of education course levels',
  })
  @ApiResponse({
    status: 200,
    description: 'Education course levels retrieved successfully',
  })
  @ApiResponse({ status: 400, description: 'Bad request - validation error' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
  ...
  @RequirePermissions(PERMISSIONS.EDUCATION_COURSE_LEVELS.READ)
  @ApiOperation({
    summary: 'Get education course levels combobox list',
  })
  @ApiResponse({
    status: 200,
    description: 'Education course levels combobox retrieved successfully',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
