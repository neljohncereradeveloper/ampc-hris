...
import {
  CreateLeaveYearConfigurationDto,
  UpdateLeaveYearConfigurationDto,
} from '../dto/leave-year-configuration';
...
export class LeaveYearConfigurationController {
  ...
  @ApiParam({
    name: 'id',
    description: 'Leave year configuration ID',
    example: 1,
  })
  ...
  @ApiResponse({
    status: 404,
    description: 'Leave year configuration not found',
  })
  @ApiResponse({ status: 400, description: 'Bad request - validation error' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
  ...
  @ApiResponse({
    status: 200,
    description: 'Leave year configuration archived successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Leave year configuration not found',
  ...
  @RequirePermissions(PERMISSIONS.LEAVE_YEAR_CONFIGURATIONS.READ)
  @ApiOperation({
    summary: 'Get active leave year configuration for a given date',
  })
  @ApiParam({
    name: 'date',
  ...
  @ApiResponse({
    status: 200,
    description: 'Active leave year configuration retrieved successfully',
  })
  @ApiResponse({
    status: 404,
    description: 'Active leave year configuration not found',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiBearerAuth('JWT-auth')
